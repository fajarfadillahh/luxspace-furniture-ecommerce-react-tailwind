      ...
      <div className="container mx-auto py-10">
        <div className="flex-stretch flex items-center">
          ...
          <div className="w-auto">
            <ul
              id="menu"
              className="invisible fixed inset-0 flex flex-col items-center justify-center bg-white opacity-0 md:visible md:relative md:flex-row md:bg-transparent md:opacity-100"
            >
          ...
          <div className="w-auto">
            <ul className="flex items-center">
              <li className="ml-6 block md:hidden">
                <button className="relative z-50 flex h-8 w-8 items-center justify-center text-black focus:outline-none">
                  <svg
