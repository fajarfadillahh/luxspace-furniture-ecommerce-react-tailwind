...
import SitemapLogo from "../assets/images/design/logo.svg";

export default function Sitemap() {
  return (
    <section>
      <div className="mt-16 border-t border-b border-gray-200 py-12 px-4">
        ...
        <aside className="container mx-auto">
          <div className="flex flex-wrap justify-center md:space-x-4">
            <div className="accordion mb-4 w-full md:mb-0 md:w-2/12">
              <h5 className="relative mb-2 text-xl font-semibold">Overview</h5>

              <ul className="invisible h-0 overflow-hidden md:visible md:h-auto">
                <li>
                  <Link to="/shipping" className="block py-1 hover:underline">
                    Shippping
                  </Link>
                </li>
                <li>
                  <Link to="/refund" className="block py-1 hover:underline">
                    Refund
                  </Link>
                </li>
                <li>
                  <Link to="/promotion" className="block py-1 hover:underline">
                    Promotion
                  </Link>
                </li>
              </ul>
            ...
            <div className="accordion mb-4 w-full md:mb-0 md:w-2/12">
              <h5 className="relative mb-2 text-xl font-semibold">Company</h5>

              <ul className="invisible h-0 overflow-hidden md:visible md:h-auto">
                <li>
                  <Link to="/about" className="block py-1 hover:underline">
                    About
                  </Link>
                </li>
                <li>
                  <Link to="/career" className="block py-1 hover:underline">
                    Carrer
                  </Link>
                </li>
                <li>
                  <Link to="/contact-us" className="block py-1 hover:underline">
                    Contact Us
                  </Link>
                </li>
              </ul>
            ...
            <div className="accordion mb-4 w-full md:mb-0 md:w-2/12">
              <h5 className="relative mb-2 text-xl font-semibold">Explore</h5>

              <ul className="invisible h-0 overflow-hidden md:visible md:h-auto">
                <li>
                  <Link to="/terms-cons" className="block py-1 hover:underline">
                    Terms & Conds
                  </Link>
                </li>
                <li>
            ...
            <div className="mb-4 w-full md:mb-0 md:w-3/12">
              <h5 className="relative mb-2 text-xl font-semibold">
                Special Letter
              </h5>
              ...
              <form action="#">
                <label className="relative w-full">
                  ...
                  <button className="absolute right-0 rounded-xl bg-pink-400 p-3 text-white">
                    <svg
